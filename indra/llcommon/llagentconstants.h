...
// <CV:David>
const U32 AGENT_WALK_SLOW					= 1;
const U32 AGENT_WALK_MEDIUM_SLOW			= 2;
const U32 AGENT_WALK_MEDIUM					= 3;
const U32 AGENT_WALK_MEDIUM_FAST			= 4;
const U32 AGENT_WALK_FAST					= 5;
// </CV:David>
